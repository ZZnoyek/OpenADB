# OpenABD
A platform for AI agents like opencode to interact with your android device through adb (only on Linux) and especially for AIs that do not have machine vision.
...
**2. Please have opencode installed from the official website. (NOT FROM SNAP, ATP, PACKMAN, FLATPAK ext...) As you need opencode installed BEFORE installing OpenADB (the install command for the official opencode thing is "curl -fsSL https://opencode.ai/install | bash" IF you dont trust that command visit the website and you will see "https://opencode.ai/" please use the command And NOT the desktop app.**
...
**Thinking about updates to make....**
